...
export default function CadastroEquipamentosGerais() {
  ...
  const filteredData = data?.filter(item => 
    ...
    item.Descricao_Eq?.toLowerCase().includes(search.toLowerCase())
  ) || [];
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="page-header">
          ...
          <p className="page-subtitle">Outros equipamentos</p>
        </div>
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2"><Label>Prefixo</Label><Input placeholder="Ex: EQ-001" /></div>
              <div className="space-y-2"><Label>Descrição</Label><Input placeholder="Descrição do equipamento" /></div>
              ...
              <div className="space-y-2"><Label>Potência</Label><Input placeholder="Ex: 150HP" /></div>
              ...
              <TableBody>
                {filteredData.map((item, idx) => (
                  <TableRow key={idx}>
                    ...
                    <TableCell>{item.Descricao_Eq}</TableCell>
